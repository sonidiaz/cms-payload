...
export const ImageMediaHTML: React.FC<MediaProps> = (props) => {
  const {
    alt: altFromProps,
    fill,
    imgClassName,
  ...
  return (
    <img
      ...
      // El placeholderBlur no se usa en <img>, pero puedes agregar un fondo si quieres
    />
  )
}

export default ImageMediaHTML
