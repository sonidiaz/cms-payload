export const glTranslations = {
    ...
    general: {
        aboutToDelete: 'Est s por eliminar o {{label}} <1>{{title}}</1>. Est s seguro?',
        aboutToDeleteCount_many: 'Est  a punto de eliminar {{count}} {{label}}',
        aboutToDeleteCount_one: 'Est  a punto de eliminar {{count}} {{label}}',
        aboutToDeleteCount_other: 'Est  a punto de eliminar {{count}} {{label}}',
        addBelow: 'Engadir abaixo',
        addFilter: 'Engadir filtro',
        adminTheme: 'Tema do panel de administraci n',
        all: 'Todo',
        allCollections: 'Todas as colecci ns',
        and: 'E',
        anotherUser: 'Outro usuario',
        anotherUserTakenOver: 'Outro usuario tomou o control de edici n deste documento.',
